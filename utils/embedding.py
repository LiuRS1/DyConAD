...
import math
import pdb
from model.tem_attention import TemporalAttentionLayer_recovery
...
class GraphEmbedding(EmbeddingModule):
    ...
    def compute_recovery_memory_embedding(self, memory, source_nodes, timestamps, neighbors, neighbors_time, n_layers,
                                          n_neighbors=20):
        assert (n_layers >= 0)
